...
import com.example.budgetmanagement.Adapters.TransactionAdapter;
import com.example.budgetmanagement.Authentication.LoginActivity;
import com.example.budgetmanagement.Authentication.RegisterActivity;
import com.example.budgetmanagement.Database.DatabaseHelper;
import com.example.budgetmanagement.Dialogs.AddTransactionDialog;
import com.example.budgetmanagement.Models.Shopping;
import com.example.budgetmanagement.Models.Transaction;
...
public class MainActivity extends AppCompatActivity {
    ...
    private Button btn; //logout test
        ...
        switch (item.getItemId()) {
            case R.id.menu_meicode:
                AlertDialog.Builder builder = new AlertDialog.Builder(this)
                        .setTitle("APT3065")
                        .setMessage("Money Management App.")
                        .setPositiveButton("Invite friends", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialogInterface, int i) {
                                String message = "Hey, How are you?\\nCheckout this awesome new app. it helps me manage my money." +
                                        "\nhttps://github.com/wesleyopenda?tab=repositories";
